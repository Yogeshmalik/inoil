...
//   return (
//     <div className="sticky top-0 w-full overflow-auto z-20 drop-shadow-lg">
//       <div className="flex px-4 bg-[#03174f] justify-between w-full">
...
//             </svg>
//           </button>
//           {/* Navigation items (conditionally displayed based on mobileMenuOpen state) */}
//           {mobileMenuOpen && (
//           <nav className="space-x-4">
//             <ul className="flex items-center sm:space-x-4 md:space-x-10">
//               <li>
...
//             } flex flex-col space items-center focus:outline-none`}
//           >
//             <div className="flex space-x-10 pt-4 flex-col items-center">
//               {icon}
//               {title}
//               {dropdownIcon}
//             </div>
    ...
    <div className="sticky top-0 w-full overflow-auto z-20 drop-shadow-lg">
      ...
      <div className="bg-gradient-to-r from-[#03174f] to-[#f37022] py-4 px-4 w-full">
        <div className="container mx-auto flex justify-between items-center">
          ...
          {/* Navigation items (conditionally displayed based on mobileMenuOpen state) */}
          {mobileMenuOpen ? <MobileMenu /> : <NavItems />}
        </div>
      </div>
    </div>
  );
